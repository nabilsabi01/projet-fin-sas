...
void inputUser(int index)
{
    ...
    scanf("%d/%d/%d", &taches[index].date_fin.jour, &taches[index].date_fin.mois, &taches[index].date_fin.annee);
...
void filtrerTaches()
{
    int filtre, priorite, statut;
    Date date;
    printf("Choisir le Filterage (1: Priorite, 2: Date Fin) : ");
    scanf("%d", &filtre);
    switch (filtre)
    {
    case 1:
        ...
        scanf("%d", &priorite);
        printf("--------------------------------------------------------------\n");
        printf("|            Liste des taches filter par priorite            |\n");
        printf("--------------------------------------------------------------\n");
        for (int i = 0; i < nbrTaches; i++)
        {
        ...
        break;
    case 2:
        printf("Entrez la date fin : ");
        scanf("%d/%d/%d", &date.jour, &date.mois, &date.annee);
        printf("--------------------------------------------------------------\n");
        printf("|       Liste des taches filter par date fin %d/%d/%d        |\n", date.jour, date.mois, date.annee);
        printf("--------------------------------------------------------------\n");
        for (int i = 0; i < nbrTaches; i++)
        {
            if (taches[i].date_fin.jour == date.jour && taches[i].date_fin.mois == date.mois && taches[i].date_fin.annee == date.annee)
            {
                afficher(i);
            }
        }
    case 3:
        ...
        scanf("%d", &statut);
        printf("--------------------------------------------------------------\n");
        printf("|            Liste des taches filter par statis              |\n");
        printf("--------------------------------------------------------------\n");
        for (int i = 0; i < nbrTaches; i++)
        {
            if (taches[i].statut == statut)
            {
                afficher(i);
            }
        }
